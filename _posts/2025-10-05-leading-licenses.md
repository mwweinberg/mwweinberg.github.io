...
layout: post
category: blog
title: The Most Popular Open Source Hardware Licenses (2016-2025)
date: 2025-10-05
tags:
- copyright
- opensourcehardware
image:
     feature: racetrack.png
...
This [Open Hardware Month](https://ohm.oshwa.org/) my modern mind, like yours, had these [three questions](https://youtu.be/DQaF4YXCXsc?feature=shared&t=20). Fortunately, the OSHWA [Open Source Hardware Certification API](https://certificationapi.oshwa.org/documentation) makes it possible to start answering them.  

This post has leaderboards for all of the licenses used for certified hardware, as well as hardware, software, and documentation specific leaderboards.  I'm not sure if there is a revelatory take away from them right now, but the leaderboards may be helpful in the future.

If you don't want to read the context about the data, jump right to the leaderboard you care about:

- [All Licenses](#all_license)
- [Hardware Licenses](#hardware)
- [Software Licenses](#software)
- [Documentation Licenses](#documentation)

If you don't want to deal with that API, you can find the raw data from this post (and some tools for working with them) in [this repo](https://github.com/mwweinberg/OSHWA-license-counter).
...
Some people use this flexibility to choose licenses designed with each element of the bundle in mind. For example, they will use a Creative Commons license for the project documentation, a well known open source software license for the software, and a hardware-specific license for the hardware.
...
# <a name="hardware"></a> Hardware Licenses
...
## Hardware Licenses 2025 (so far)

| License | Total | Rank | Previous Rank | 
|------:|:-----:|:----:|:-----:|
| CERN-OHL-S-2.0 | 52 | 1 | 2 &#9650; |
| Other | 46 | 2 | 1 &#9660; |
| CERN-OHL-P-2.0 | 35 | 3 | 4 &#9650; |
| CC-BY-SA-4.0 | 25 | 4 | 3 &#9660; |
| GPL-3.0-or-later | 19 | 5 | 7 &#9650; |
| CERN-OHL-W-2.0 | 17 | 6 | 5 &#9660; |
| CC-BY-4.0 | 5 | 7 | 8 &#9650; |
| GPL-3.0-only | 4 | 8 | 10 &#9650; |
| CERN | 4 | 9 | 11 &#9650; |
| MIT | 3 | 10 |  |
...
# <a name="software"></a> Software Licenses
...
The other notable entry on the list is the `No software` option.  This likely reflects two factors. First, many certified projects are relatively simple boards that do not need additional firmware (or simply use widely available open source firmware maintained by others). Second, there is a lot of certified open source hardware that is not electronics! I'm looking at you, [Touch Grass](https://certification.oshwa.org/us002180.html).

## Software Licenses 2025 (so far)

| License | Total | Rank | Previous Rank | 
|------:|:-----:|:----:|:-----:|
| MIT | 79 | 1 | 1 |
| GPL-3.0-or-later | 35 | 2 | 2 |
| No software | 33 | 3 | 3 |
| GPL | 15 | 4 | 7 &#9650; |
| GPL-3.0-only | 14 | 5 | 6 &#9650; |
| CC-BY-SA-4.0 | 13 | 6 | 4 &#9660; |
| Apache | 7 | 7 | 5 &#9660; |
| CERN-OHL-S-2.0 | 5 | 8 | 11 &#9650; |
| Other | 4 | 9 | 8 &#9660; |
| LGPL | 3 | 10 | 12 &#9650; |
| CC-BY-4.0 | 3 | 11 | 10 &#9660; |
| CERN-OHL-W-2.0 | 3 | 12 | 14 &#9650; |
| CERN-OHL-P-2.0 | 1 | 13 | 9 &#9660; |
...
# <a name="documentation"></a> Documentation Licenses
...
## Documentation Licenses 2025 (so far)
...
| CC-BY-SA-4.0 | 45 | 2 | 1 &#9660; |
| CC-BY-4.0 | 32 | 3 | 3 |
| GPL-3.0-or-later | 20 | 4 | 4 |
| Other | 18 | 5 | 5 |
| CERN-OHL-P-2.0 | 14 | 6 | 10 &#9650; |
| CERN-OHL-S-2.0 | 13 | 7 | 6 &#9660; |
| GPL-3.0-only | 6 | 8 | 8 |
| CERN-OHL-W-2.0 | 5 | 9 | 12 &#9650; |
| CC BY | 3 | 10 | 7 &#9660; |
| CC 0 | 3 | 11 | 13 &#9650; |
| MIT | 3 | 12 |  |
| GPL | 3 | 13 | 11 &#9660; |
